...
export default function Home() {
  const anfitriones = [
    {
      ...
      // CAMBIO DE ROL: Ahora es Anfitrión Turístico
      rol: "Anfitrión Turístico", 
      wa: "https://wa.me/595961793791",
      ig: "https://www.instagram.com/gonza8511",
      foto: "/GONZALO,GALEANO.jpg" // Nombre exacto de tu foto en public
    },
    {
      ...
      foto: "/Jose,Luis,Molas.png" // Nombre exacto de tu foto en public
    }
  ];
  ...
  return (
    <div style={{ 
      ...
      {/* SECCIÓN DE ANFITRIONES: Un diseño vertical optimizado */}
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '30px', alignItems: 'center' }}>
          {anfitriones.map((a, i) => (
            <div key={i} style={{ 
              ...
              {/* Espacio para la foto CON ALINEACIÓN ARRIBA */}
              <div style={{ 
                height: '420px', // Un poco más alta para que se luzca
                backgroundImage: `url(${a.foto})`, 
                backgroundSize: 'cover', 
                backgroundPosition: 'top', // LA CLAVE: Alinea la imagen arriba para ver la cara
              ...
              <div style={{ padding: '1.5rem', textAlign: 'center' }}>
                ...
                {/* Texto del rol unificado: Anfitrión Turístico */}
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: '10px' }}>
                  ...
                  <a href={a.ig || a.fb} target="_blank" rel="noreferrer" style={{ textDecoration: 'none' }}>
                    <button style={{ width: '100%', padding: '12px', borderRadius: '10px', border: 'none', background: a.ig ? '#E1306C' : '#3b5998', color: '#fff', fontWeight: 'bold', cursor: 'pointer' }}>Social</button>
                  </a>
                </div>
              </div>
            </div>
      ...
      <section style={{ margin: '3rem 1rem', padding: '2rem', background: '#fff', borderRadius: '20px', textAlign: 'center', border: '3px solid #f96854' }}>
        ...
        <a href={linkPatreon} target="_blank" rel="noreferrer">
          <button style={{ background: '#f96854', color: '#fff', padding: '15px 25px', borderRadius: '10px', border: 'none', fontWeight: 'bold', fontSize: '1.1rem', cursor: 'pointer' }}>Ser Mecenas en Patreon</button>
        </a>
      </section>
      ...
      <footer style={{ marginTop: '4rem', textAlign: 'center', padding: '3rem 1rem', background: '#1a1a1a' }}>
        <Link href="/suscripcion">
          <p style={{ color: '#ffcc66', cursor: 'pointer', textDecoration: 'underline', fontSize: '1.1rem', fontWeight: 'bold' }}>¿Tenes un comercio en la Chaca? Sumate acá</p>
        </Link>
